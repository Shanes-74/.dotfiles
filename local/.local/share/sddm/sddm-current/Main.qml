...
Rectangle {
    ...
    Rectangle {
        ...
        // O width agora se ajusta automaticamente ao conteúdo do Row
        width: statusLayout.implicitWidth + Math.round(64 * dp) 
        anchors {
            top: parent.top
        ...
        Row {
            ...
            spacing: Math.round(24 * dp) // Espaçamento entre a Data e o PowerBar

            // Exibição da Data
            Text {
                id: dateText
                anchors.verticalCenter: parent.verticalCenter
                text: Qt.formatDateTime(new Date(), "d MMM, dddd")
            ...
            // O seu componente PowerBar atualizado
            PowerBar {
                id: powerBar
                anchors.verticalCenter: parent.verticalCenter
    ...
    Item {
        ...
        // Container para o texto e a sombra
        Item {
            id: unlockTextContainer
            width: unlockText.implicitWidth
            height: unlockText.implicitHeight
            anchors {
            ...
            Text {
                ...
                font.family: config.fontFamily
                antialiasing: true
                // Removemos o style: Text.Outline daqui
            }

            DropShadow {
                anchors.fill: unlockText
                source: unlockText
                radius: 6 * dp          // Sombra curta para não borrar muito
                samples: 6
                color: "#FF000000"      // Preto total
                horizontalOffset: 0
                verticalOffset: 0
                spread: 0.1
            }
    ...
    Item {
        ...
        Rectangle {
            ...
            Column {
                ...
                // Campo de senha (com dots inspirados no hyprlock)
                TextField {
                    id: passwordField
                    ...
                    // dots_size = 0.32 e dots_spacing = 1.2 simulados aqui:
                    font.pixelSize: Math.round(26 * dp)
                    font.letterSpacing: Math.round(8 * dp)
                    ...
                    Text {
                        ...
                        color: container.extractedAccent
                        font.pixelSize: Math.round(16 * dp)
                        font.letterSpacing: 0 // Reseta o espaçamento para o placeholder ficar normal
